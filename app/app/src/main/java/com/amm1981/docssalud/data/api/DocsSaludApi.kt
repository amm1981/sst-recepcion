...
interface DocsSaludApi {
    ...
    suspend fun uploadDocument(
        ...
        @Part("worker_position_snapshot") workerPositionSnapshot: RequestBody?,
        @Part("worker_management_id_snapshot") workerManagementIdSnapshot: RequestBody?,
        @Part("worker_management_name_snapshot") workerManagementNameSnapshot: RequestBody?,
        @Part("worker_sector_id_snapshot") workerSectorIdSnapshot: RequestBody?,
        @Part("worker_sector_name_snapshot") workerSectorNameSnapshot: RequestBody?,
        @Part("document_date") documentDate: RequestBody,
...
data class MedicalDocumentDto(
    ...
    @SerializedName("worker_position_snapshot") val workerPositionSnapshot: String? = null,
    @SerializedName("worker_management_id_snapshot") val workerManagementIdSnapshot: Int? = null,
    @SerializedName("worker_management_name_snapshot") val workerManagementNameSnapshot: String? = null,
    @SerializedName("worker_sector_id_snapshot") val workerSectorIdSnapshot: Int? = null,
    @SerializedName("worker_sector_name_snapshot") val workerSectorNameSnapshot: String? = null,
