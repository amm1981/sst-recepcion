...
data class SyncQueueEntity(
    ...
    val workerPositionSnapshot: String?,
    val workerManagementIdSnapshot: Int?,
    val workerManagementNameSnapshot: String?,
    val workerSectorIdSnapshot: Int?,
    val workerSectorNameSnapshot: String?,
