...
data class DocumentUi(
    ...
    val workerManagementName: String?,
    val workerSectorName: String?,
...
class DocumentRepository @Inject constructor(
    ...
    suspend fun enqueueDocument(
        ...
        workerDni: String,
        workerName: String,
        workerPositionSnapshot: String?,
        workerManagementIdSnapshot: Int?,
        workerManagementNameSnapshot: String?,
        workerSectorIdSnapshot: Int?,
        workerSectorNameSnapshot: String?,
        documentDate: String,
        ...
        try {
            ...
            val entity = SyncQueueEntity(
                ...
                workerPositionSnapshot = workerPositionSnapshot,
                workerManagementIdSnapshot = workerManagementIdSnapshot,
                workerManagementNameSnapshot = workerManagementNameSnapshot,
                workerSectorIdSnapshot = workerSectorIdSnapshot,
                workerSectorNameSnapshot = workerSectorNameSnapshot,
    ...
    private suspend fun uploadQueueItem(item: SyncQueueEntity): Boolean {
        return try {
            val response = api.uploadDocument(
                ...
                workerPositionSnapshot = nullableTextPart(item.workerPositionSnapshot),
                workerManagementIdSnapshot = item.workerManagementIdSnapshot?.let { textPart(it.toString()) },
                workerManagementNameSnapshot = nullableTextPart(item.workerManagementNameSnapshot),
                workerSectorIdSnapshot = item.workerSectorIdSnapshot?.let { textPart(it.toString()) },
                workerSectorNameSnapshot = nullableTextPart(item.workerSectorNameSnapshot),
                documentDate = textPart(item.documentDate),
    ...
    private fun MedicalDocumentDto.toUi(): DocumentUi {
        ...
        return DocumentUi(
            ...
            workerName = workerName,
            workerPosition = workerPositionSnapshot ?: worker?.position,
            workerManagementName = workerManagementNameSnapshot ?: worker?.management?.name,
            workerSectorName = workerSectorNameSnapshot ?: worker?.sector?.name,
            documentDate = documentDate,
            contactNumber = contactNumber,
            delivererName = delivererName,
            delivererDocument = delivererDocument,
    ...
    private fun SyncQueueEntity.toUi(): DocumentUi {
        ...
        return DocumentUi(
            ...
            workerDni = workerDni,
            workerName = workerName,
            workerPosition = workerPositionSnapshot,
            workerManagementName = workerManagementNameSnapshot,
            workerSectorName = workerSectorNameSnapshot,
            documentDate = documentDate,
            contactNumber = contactNumber,
            delivererName = delivererName,
            delivererDocument = delivererDocument,
